...
$customcontent = '<div class="row justify-content-center">
	<div class="col-lg-4">
		<div class="card mb-1">
			<h3 class="card-header">How do I access my feed?</h3>
			<div class="card-block">
				<p class="card-text">Your personal feed is located at '.LOCAL_URL.'user/username/feed</p>
...
$output = $pug->render('views/customContent.pug', array(
	'title' => "FAQ",
	'subdir' => SUBDIR,
	'loggedIn' => $loggedin,
	'localurl' => LOCAL_URL,
