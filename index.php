<html>
<head>
    <title>YoutTube to Podcast</title>
...
<body>
	<div class="container-fluid">
		...
		<div class="input-group" style="margin-bottom:20px; width:100%;">
			<input type="text" id="yt" class="form-control"></input>
		</div>
		<div class="progress">
			<div class="progress-bar progress-total" role="progressbar"
			aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
			</div>
		</div>
		<div class="progress">
			<div class="progress-bar progress-stage" role="progressbar"
			aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
			</div>
		</div>
